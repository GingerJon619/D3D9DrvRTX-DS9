...
parse.add_argument("--game-define", default=None, help="Preprocessor define identifying the game (e.g. DEEP_SPACE_NINE)")
...
if args.game_define:
	preprocessor_defs.append(args.game_define)
