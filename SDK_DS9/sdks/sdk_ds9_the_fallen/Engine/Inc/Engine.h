...
public:
    ...
    // Bodies are defined out-of-line in DS9Compat.cpp so the linker can resolve
    // the vtable slots without needing Engine.dll to export them.
    ...
    virtual UBOOL SupportsTextureFormat(ETextureFormat Fmt);
